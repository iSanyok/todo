<x-app-layout>
    <x-slot name="header">
        <div class="container">
            <h1>Дата</h1>
            <input class="date form-control" type="text" style="width: 200px">
        </div>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200 text">
                    ...
                    @forelse($posts as $post)
                        <div style="border-bottom: solid 1px darkgrey; margin-top: 1em">
                    ...
                    @endforelse
                        ...
                        <button class="btn btn-add btn-success" style="margin-top: 2em">Добавить</button>
                </div>
            </div>
        </div>
    </div>
